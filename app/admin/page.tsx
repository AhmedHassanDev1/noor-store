...
export default async function AdminPage(){
  ...
  return (
    <div className="bg-surface font-body-md text-on-surface antialiased min-h-screen" dir="rtl">
        ...
        <div className="h-20 w-full px-margin-mobile md:px-space-lg lg:px-margin flex items-center justify-between">
          <div className="flex items-center gap-space-lg">
            <Link href="/" className="group flex flex-col">
              ...
              <span className="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-[0.2em] -mt-1">الجمال الفاخر</span>
            </Link>
            <div className="hidden md:block h-6 w-[1px] bg-outline-variant/50"></div>
            <nav className="flex items-center gap-space-xs">
              <Link href="/" className="px-space-sm py-space-xs rounded-full font-label-md text-label-md text-on-surface-variant hover:bg-surface-container hover:text-on-surface transition-all">المتجر</Link>
              <Link href="/admin" aria-current="page" className="px-space-sm py-space-xs rounded-full transition-all bg-surface-container-highest text-primary font-semibold shadow-sm">إدارة المنتجات</Link>
            </nav>
          </div>
      ...
      <footer className="w-full bg-surface-container-low shadow-[0_-1px_6px_rgba(143,58,72,0.03)] mt-space-xl py-space-lg">
        <div className="w-full px-margin-mobile md:px-space-lg lg:px-margin flex flex-col md:flex-row items-center justify-between gap-space-sm">
          <div className="flex items-center gap-space-xs">
            ...
            <span className="font-label-sm text-label-sm text-on-surface-variant">— لوحة الإدارة</span>
          </div>
          <div className="font-body-sm text-body-sm text-on-surface-variant">© 2026 متجر نور — الجمال الفاخر. جميع الحقوق محفوظة.</div>
        </div>
      </footer>
    </div>
  )
