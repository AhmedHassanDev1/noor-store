      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl p-8 sm:p-10 shadow-[0_4px_25px_-4px_rgba(178,75,91,0.06),0_1px_3px_rgba(0,0,0,0.03)] border border-brand-100/80 transition-all duration-300">
          <div className="text-center mb-8">
            <h1 className="font-serif text-2xl sm:text-3xl text-brand-dark tracking-tight mb-2">Create account</h1>
            <p className="text-xs sm:text-sm text-brand-muted font-light">Join Noor Store for curated beauty rituals and exclusive perks</p>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-brand-50 text-center">
            <p className="text-xs sm:text-sm text-brand-muted">
              ...
              <Link href="/login" className="text-brand-600 hover:text-brand-800 font-medium ml-1 underline decoration-brand-200 underline-offset-2 hover:decoration-brand-600 transition">
                Login
              </Link>
            </p>
          </div>
